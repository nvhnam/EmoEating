...
本模型是 [**FunASR**](https://github.com/modelscope/FunASR) 语音生态的组件模型之一,可与 ASR 模型自由组合成完整流程。FunASR 一套工具打通 **ASR · VAD · 标点 · 说话人分离 · 情感 / 事件识别 · LLM-ASR**,一行代码即可调用本模型。
...
本版本(emotion2vec_plus_seed)为在学术数据上训练的种子模型，目前支持的分类为：
    0: angry
    1: disgusted
    2: fearful
    3: happy
